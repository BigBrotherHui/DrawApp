...
#include "../../../DrawApp/app/layer/layermanager.h"
...
void LayerManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LayerManager::layerChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LayerManager::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_LayerManager.data,
    qt_meta_data_LayerManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void LayerManager::layerChanged()
{
