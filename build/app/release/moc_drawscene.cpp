...
#include "../../../DrawApp/app/drawscene.h"
...
static const uint qt_meta_data_DrawScene[] = {
 ...
 // signals: name, argc, parameters, tag, flags
      ...
      12,    4,   64,    2, 0x06 /* Public */,
      15,    0,   73,    2, 0x06 /* Public */,
...
void DrawScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DrawScene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawScene::itemRemoved)) {
                *result = 5;
                return;
            }
        }
