...
#include "../../../DrawApp/app/widgets/ruler.h"
...
QT_MOC_LITERAL(1, 6, 24), // "signal_zoomFactorChanged"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "Ruler\0signal_zoomFactorChanged\0"
};
...
void Ruler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_zoomFactorChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Ruler::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Ruler::signal_zoomFactorChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Ruler::signal_zoomFactorChanged(int _t1)
{
