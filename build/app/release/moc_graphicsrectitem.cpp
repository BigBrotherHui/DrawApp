...
#include "../../../DrawApp/app/items/graphicsrectitem.h"
...
QT_MOC_LITERAL(1, 17, 11), // "refreshItem"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 13) // "GraphicsItem*"

    },
    "GraphicsRectItem\0refreshItem\0\0"
    "GraphicsItem*"
};
...
void GraphicsRectItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GraphicsRectItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->refreshItem((*reinterpret_cast< GraphicsItem*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (GraphicsRectItem::*)(GraphicsItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsRectItem::refreshItem)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GraphicsRectItem::staticMetaObject = { {
    &GraphicsItem::staticMetaObject,
    qt_meta_stringdata_GraphicsRectItem.data,
    qt_meta_data_GraphicsRectItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void GraphicsRectItem::refreshItem(GraphicsItem * _t1)
{
