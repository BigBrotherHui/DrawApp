...
#include "../../../DrawApp/app/drawview.h"
...
QT_MOC_LITERAL(5, 30, 11), // "sizeChanged"
QT_MOC_LITERAL(6, 42, 11), // "updateScene"
QT_MOC_LITERAL(7, 54, 6) // "pixmap"

    },
    "DrawView\0positionChanged\0\0x\0y\0sizeChanged\0"
    "updateScene\0pixmap"
};
...
void DrawView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->updateScene((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (DrawView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawView::sizeChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (DrawView::*)(QPixmap );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawView::updateScene)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void DrawView::sizeChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void DrawView::updateScene(QPixmap _t1)
{
