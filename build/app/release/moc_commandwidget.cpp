...
#include "../../../DrawApp/app/command/commandwidget.h"
...
QT_MOC_LITERAL(1, 14, 18), // "signal_sendCommand"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 3), // "cmd"
QT_MOC_LITERAL(4, 38, 25) // "on_lineEdit_returnPressed"

    },
    "CommandWidget\0signal_sendCommand\0\0cmd\0"
...
void CommandWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_sendCommand((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommandWidget::signal_sendCommand)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CommandWidget::signal_sendCommand(QString _t1)
{
