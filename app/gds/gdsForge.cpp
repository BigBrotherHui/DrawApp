...
{
  int data[1];
  int *corXY=new int[in_PATH.xCor.size() * 2];
...
{
  int data[1];
  int *corXY=new int[in_BOUNDARY.xCor.size() * 2];
...
{
  int data[1];
  int *corXY=new int[in_NODE.xCor.size() * 2];
...
{
  int data[1];
  int *corXY=new int[in_BOX.xCor.size() * 2];
